              ...
              <CardContent className="p-3 sm:p-4 lg:p-6 xl:p-8">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-slate-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
                    ...
                    <Button variant="outline" className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200 hover:shadow-lg hover:bg-white text-sm h-11 shadow-md text-[#000000]" onClick={exportToJson}>
                    ...
                    <Button 
                      variant="outline" 
                      className="bg-gradient-to-r from-purple-50 to-indigo-50 border-purple-200 hover:shadow-lg hover:bg-white text-sm h-11 shadow-md"
                      onClick={() => {
                        const summary = `
